...
import multimedia.channel.StreamClientChannelPipelineFactory;
...
public class StreamClientAgent implements IStreamClientAgent {
	...
	protected final static Logger logger = LoggerFactory
			.getLogger(StreamClientAgent.class);
	...
	public StreamClientAgent(StreamFrameListener streamFrameListener,
		...
		this.clientBootstrap
				.setPipelineFactory(new StreamClientChannelPipelineFactory(
						streamClientListener, streamFrameListener, dimension));
	}

	public void connect(SocketAddress streamServerAddress) {
		logger.info("going to connect to stream server :{}",
				streamServerAddress);
